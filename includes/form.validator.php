...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(isset($text['competition']['question']) && !empty($text['competition']['question'])) {
        ...
        if (isset($_POST['answer']) && !empty($_POST['answer'])) {
            ...
            if (isset($text['competition']['answerLimit']) && strlen(utf8_decode($_POST['answer'])) > $text['competition']['answerLimit']) {
