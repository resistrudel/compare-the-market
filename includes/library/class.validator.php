...
class Entry
{
	private static $form = array(
		...
		'stationOptIn' => array('label' => '[CUSTOM LABEL REQUIRED]', 'type' => 'checkbox', 'required' => false, 'noValue' => 0),
	...
	public function answerElement($idx, $val, $el_type = 'li')
	{
		...
		$el_id = 'a' . $idx;
        $newVal = str_replace('<br/>', ' ', $val);
		$output = <<<OUTPUT
			<$el_type>
				<input type="radio" id="$el_id" name="answer"  value="$newVal" $checked />
